  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-2xl font-bold text-clay-charcoal">種族值</h3>
        ...
        {STAT_ORDER.map(statName => {
          ...
          return (
            <div key={statName} className="flex items-center gap-2">
              <span className="w-16 text-base text-clay-silver text-right shrink-0">
              ...
              <span className="w-9 text-sm font-mono text-clay-silver text-right shrink-0">
                {base}
              </span>
              ...
              <input
                ...
                className="w-14 text-base font-mono text-center border border-clay-border rounded py-0.5 focus:outline-none focus:ring-1 focus:ring-clay-blue/30 shrink-0"
              />
              ...
              <button
                ...
                title="加到上限"
                className="text-sm font-bold w-8 h-7 rounded bg-clay-blue-light text-clay-blue hover:bg-clay-blue-mid disabled:opacity-30 shrink-0 flex items-center justify-center"
              >▲</button>
              ...
              <button
                ...
                disabled={bp === 0}
                title="歸零"
                className="text-sm font-bold w-8 h-7 rounded bg-clay-oat text-clay-silver hover:bg-clay-border/50 disabled:opacity-30 shrink-0 flex items-center justify-center"
              >✕</button>
            </div>
          );
        })}

        <div className="flex items-center gap-2 border-t border-clay-border pt-3 mt-1">
          <span className="w-16 text-base font-bold text-clay-charcoal text-right">合計</span>
          <span className="w-12 text-base font-mono font-black text-clay-charcoal text-right">{total}</span>
        </div>
      </div>

      <p className="text-sm text-clay-silver mt-3 text-right">
